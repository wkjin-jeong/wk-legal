---
name: ko-law-api
description: 대한민국 법령(법률·시행령·시행규칙)·행정규칙(고시·훈령·예규)·자치법규의 본문·조문, 별표·서식 파일, 법제처 법령해석례를 국가법령정보 OPEN API(law.go.kr/DRF)로 검색·조회·다운로드·인용하는 skill. "○○법 ○조 찾아줘", "법령 검색", "별표·서식 다운로드", "법령해석례 검색" 등 한국 법령 조회 요청 시, 그리고 다른 한국 법률 skill 수행 중 법령·별표·해석례 인용이 필요한 모든 상황에서 보조 호출로도 반드시 사용한다. "구법", "행위시법", "처분 당시 법령", "연혁", "신구법" 등 과거 법령 조회도 반드시 이 skill(versions·get-asof)로 수행한다. 절대 기억에 의존해 인용하지 말 것.
---
